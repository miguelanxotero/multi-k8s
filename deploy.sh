...
kubectl set image deployments/client-deployment client=miguelanxo/multi-client:$GIT_SHA
kubectl set image deployments/worker-deployment worker=miguelanxo/multi-worker:$GIT_SHA
